...
const Pricing = () => {
  ...
  const packages = [
    ...
    },
    {
      ...
      monthlyPrice: 39,
      yearlyPrice: 399,
      description: "Extended capabilities for more advanced users.",
      green: "/src/assets/green-dot.png",
    },
    {
      name: "Premium",
      ...
      yearlyPrice: 599,
      description:
        "Full package with exclusive features and additional benefits.",
      green: "/src/assets/green-dot.png",
    },
  ];
        ...
        {packages.map((pkg, index) => (
          ...
          >
            ...
            <div className="w-full mx-auto flex items-center justify-center mt-5">
              <button className="mt-6 px-10 text-secondary border border-secondary hover:bg-secondary hover:text-white font-semibold py-2 rounded-lg">
                Get Started
              </button>
            </div>
          </div>
