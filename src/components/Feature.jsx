      ...
      <div className="flex flex-col lg:flex-row justify-between items-start gap-10">
        ...
        >
          ...
          <p className="text-base text-tertiary">
            We stand out from the crowd with our unmatched dedication to quality
            and innovation. Our track record of delivering exceptional results
            speaks for itself, setting us apart as the superior choice.
          </p>
        </motion.div>
